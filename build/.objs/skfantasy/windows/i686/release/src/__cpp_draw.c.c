...
# 2 "src/draw.c" 2
# 1 "/data/data/com.termux/files/home/projetos/skill-fantasy/include/draw.h" 1



# 1 "/data/data/com.termux/files/home/projetos/skill-fantasy/include/entity.h" 1
...
# 5 "/data/data/com.termux/files/home/projetos/skill-fantasy/include/entity.h" 2
...
# 5 "/data/data/com.termux/files/home/projetos/skill-fantasy/include/draw.h" 2
# 1 "/data/data/com.termux/files/home/projetos/skill-fantasy/include/map.h" 1
# 10 "/data/data/com.termux/files/home/projetos/skill-fantasy/include/map.h"
enum tile_type {
 TILE_GRASS,
 TILE_SAND,
 TILE_WATER,
...
# 6 "/data/data/com.termux/files/home/projetos/skill-fantasy/include/draw.h" 2
# 1 "/data/data/com.termux/files/home/projetos/skill-fantasy/include/game.h" 1
...
# 7 "/data/data/com.termux/files/home/projetos/skill-fantasy/include/draw.h" 2
...
void draw_entity(struct entity *entity, int offy, int offx)
{
 (wmove((stdscr),((entity->pos.y + offy)),((entity->pos.x + offx))) == (-1) ? (-1) : waddch((stdscr),((entity->ch | (((chtype)(((entity->color))) << ((0) + 8)) & ((chtype)((((1U) << 8) - 1U)) << ((0) + 8)))))));
}

void draw_entity_on(struct entity *entity, int y, int x)
{
 (wmove((stdscr),((y)),((x))) == (-1) ? (-1) : waddch((stdscr),((entity->ch | (((chtype)(((entity->color))) << ((0) + 8)) & ((chtype)((((1U) << 8) - 1U)) << ((0) + 8)))))));
}
...
void draw_map(struct tile **map, struct position player)
{
 ...
 for (int y = -center_y; y < center_y; y++) {
  ...
  for (int x = -center_x; x < center_x; x++) {
   ...
   if (map_y >= 0 && map_x >= 0 && map_y < 1024 && map_x < 1024)
    (wmove((stdscr),((row)),((col))) == (-1) ? (-1) : waddch((stdscr),((map[map_y][map_x].ch | (((chtype)(((map[map_y][map_x].color))) << ((0) + 8)) & ((chtype)((((1U) << 8) - 1U)) << ((0) + 8)))))));
   else
    (wmove((stdscr),((row)),((col))) == (-1) ? (-1) : waddch((stdscr),((' '))));
