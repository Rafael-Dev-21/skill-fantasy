...
# 5 "/data/data/com.termux/files/home/projetos/skill-fantasy/include/game.h" 2
...
# 6 "/data/data/com.termux/files/home/projetos/skill-fantasy/include/game.h" 2
...
void update_game(struct game *game)
{
 ...
 if (new_pos.y >= 0 && new_pos.y < 1024 && new_pos.x >= 0 && new_pos.x < 1024)
...
void next_input(struct game *game)
{
 game->current_input = wgetch(stdscr);
}
